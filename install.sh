...
clear
REPO="https://raw.githubusercontent.com/rezaakbar5/sctn/main/"
start=$(date +%s)
secs_to_human() {
...
echo -e "\e[32mloading...\e[0m"
clear
izinsc="https://raw.githubusercontent.com/rezaakbar5/sctn/main/ip"
rm -f /usr/bin/user
...
TIMES="10"
CHATID="5888076846"
KEY="6462866577:AAF8kw75b8S6DDz-9RHQJb03adoQtGUztAg"
...
wget -q https://raw.githubusercontent.com/rezaakbar5/sctn/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
wget -O /etc/kyt.txt "https://github.com/rezaakbar5/sctn/raw/main/files/issue.net"
